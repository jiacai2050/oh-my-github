...
Oh My GitHub is delightful, open source tool for managing your GitHub.
...
** Usage
- =M-x oh-my-github-sync= Sync GitHub stars/repos into local database. Emacs maybe hang for a while depending on how many stars you have.
  - Note: this command only need to be executed once.
- =M-x oh-my-github-star-list= Display GitHub stars in table view.
- =M-x oh-my-github-repo-list= Display GitHub repos in table view.
