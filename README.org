...
2. Download required shared object, and rename it to =omg-dyn.so= or =dll= suffix if you are on Windows
   ...
   - or you can build it yourself with =make emacs-dyn=, be sure to install [[#Development][required dependencise]]
...
5. Set =oh-my-github-pat= and execute =oh-my-github-setup= before use.
