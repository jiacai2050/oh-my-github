...
- Emacs. Full-featured
  ...
  - *Query owned/starred repositories* by keyword or programming language
  - *Query trending repositories* by spoken language, programming language and range
...
- =M-x oh-my-github-stars-list= Display GitHub starred repositories in table view.
- =M-x oh-my-github-repos-list= Display GitHub owned repositories in table view.
